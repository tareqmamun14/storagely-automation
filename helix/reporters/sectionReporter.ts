...
const COLOR_ENABLED = process.env.HELIX_NO_COLOR == null && process.stdout.isTTY !== false;
...
export function printFacilityRollup(results: SectionResult[]): void {
  ...
  console.log('');
  console.log(c('cyan', '╭─────────────────────────────────────────────────────────────────────────'));
  console.log(c('cyan', `│ Helix Section Report  —  ${c('bold', facility)}`));
...
export function printGrandRollup(allResults: SectionResult[]): void {
  ...
  console.log('');
  console.log(c('cyan', '╔══════════════════════════════════════════════════════════════════╗'));
  console.log(c('cyan', '║                  HELIX SECTION RUN  —  GRAND TOTAL               ║'));
  console.log(c('cyan', '╚══════════════════════════════════════════════════════════════════╝'));
...
export function writeMarkdownReport(results: SectionResult[], outFile: string): void {
  ...
  const lines: string[] = [];
  lines.push(`# Helix Section Report — ${facility}`);
  lines.push('');
  lines.push(`- URL: ${url}`);
...
/** Stable report path: helix/test-results/sections/<stamp>__<facility>.<ext> */
