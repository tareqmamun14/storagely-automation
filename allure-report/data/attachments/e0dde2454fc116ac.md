...
- Name: Storage Site Landing Page Verification >> Verify landing page for https://www.firststorage.com/
...
Call log:
  - navigating to "https://www.firststorage.com/", waiting until "domcontentloaded"
...
- banner:
  - navigation:
    - link "logo":
      - /url: https://www.firststorage.com
      - img "logo"
    - list:
      - listitem:
        - button "Find Storage"
      ...
      - listitem:
        - link "Contact":
          - /url: /pages/contact
    - link "My Account":
      - /url: https://firststorage.tenantconnect.com/
    - link "Rent Now":
