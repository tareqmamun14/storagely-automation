/**
 * Per-client Flex profiles.
 *
 * Flex is becoming multi-client. The section detectors are layout-tolerant
...
/**
 * Console noise common to EVERY Flex V4 site under automation — observed on
...
const FLEX_CONSOLE_ALLOWLIST: RegExp[] = [
...
export const DEFAULT_PROFILE: ClientProfile = {
  ...
  consoleAllowlist: FLEX_CONSOLE_ALLOWLIST,
};
...
const PROFILES: Record<string, ClientProfile> = {
  ...
  minimall: {
    ...
    // Same Flex-wide console artifacts as the baseline (the reviews-API 403 is
