...
- Name: Storage Site Landing Page Verification >> Verify landing page for https://gatekeeperstoragega.com/
- Location: C:\Users\tareq\OneDrive\Documents\GitHub\storagely-automation\tests\homePage-verification.spec.ts:10:9

# Error details

```
Error: page.goto: net::ERR_NETWORK_CHANGED at https://gatekeeperstoragega.com/
Call log:
  - navigating to "https://gatekeeperstoragega.com/", waiting until "domcontentloaded"
