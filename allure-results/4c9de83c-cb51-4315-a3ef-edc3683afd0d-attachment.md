...
- Name: Verify page discount from storage unit >> Verify offer content Smart Self Storage : SSM
- Location: C:\Users\tareq\OneDrive\Documents\GitHub\storagely-automation\tests\discountBanner-verification.spec.ts:40:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://app.storagely.io/smart-self-storage-ohio/storage-units/ohio/macedonia/bavaria-road
Call log:
  - navigating to "https://app.storagely.io/smart-self-storage-ohio/storage-units/ohio/macedonia/bavaria-road", waiting until "domcontentloaded"
