...
export enum Environment {
  ...
  export const CUSTOMER_URLS = {
    [Environment.STAGING]: [
      ...
      'https://test.staging.storagely-api.com/radiant-storage/storage-units/alabama/montgomery/east-south-blvd',
    ...
    [Environment.PRODUCTION]: [
      ...
      //'https://www.firststorage.com/storage-units/north-carolina/fayetteville/raeford-road',
      ]
  };
...
export const FMS_PLATFORM: Record<string, string> = {
  ...
  'https://radiantstorage.com/storage-units/alabama/montgomery/east-south-blvd': 'storEDGE',
  'https://ww2.radiantstorage.com/storage-units/texas/beaumont/college-street': 'storEDGE',
